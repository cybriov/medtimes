        ...
        <div class="card card-stats border-0">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-auto">
                        <h6 class="text-muted mb-1"><?php echo e(__('Paid Accounts')); ?></h6>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/jovickxe/medtimes.co/resources/views/super_admin.blade.php ENDPATH**/ ?>