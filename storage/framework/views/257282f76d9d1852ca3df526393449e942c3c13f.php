                ...
                <div class="container-fluid">
                            ...
                            <li class="nav-item dropdown dropdown-animate">
                                <a class="nav-link pr-lg-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <span class="avatar avatar-sm rounded-circle">
                                        <img alt="<?php echo e((!empty(Auth::user()->first_name)) ? Auth::user()->first_name.' !' : Auth::user()->company_name.' !'); ?>"  src="<?php echo e(asset(Storage::url(Auth::user()->getUserInfo->DefaultProfilePic()))); ?>" class="avatar rounded-circle">
                                    </span>
                                </a>
                                <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right dropdown-menu-arrow">
                                    <h6 class="dropdown-header px-0"><?php echo e(__('Hi , ')); ?> <?php echo e((!empty(Auth::user()->first_name)) ? Auth::user()->first_name.' !' : Auth::user()->company_name.' !'); ?></h6>
                    ...
                    <div class="collapse navbar-collapse navbar-collapse-fade" id="navbar-main-collapse">
                        <ul class="navbar-nav align-items-lg-center">
                            ...
                            <li class="nav-item"> <a class="nav-link pl-lg-0" href="<?php echo e(url('user')); ?>"> <?php echo e(__('Users')); ?> </a> </li>                            
                            <li class="nav-item"> <a class="nav-link pl-lg-0" href="<?php echo e(url('plan')); ?>"> <?php echo e(__('Plans')); ?> </a> </li>                            
                            <li class="nav-item"> <a class="nav-link pl-lg-0" href="<?php echo e(url('coupon')); ?>"> <?php echo e(__('Coupons')); ?> </a> </li>                            
                            <li class="nav-item"> <a class="nav-link pl-lg-0" href="<?php echo e(url('order')); ?>"> <?php echo e(__('Orders')); ?> </a> </li>                            
                            <!--li class="nav-item">  <a class="nav-link pl-lg-0" href="<?php echo e(url('manage-language',Auth::user()->lang)); ?>"> <?php echo e(__('Languages')); ?> </a> </li-->
                            ...
                            <?php if(Auth::user()->type != 'super admin'): ?>
                                <!-- Rotas  -->
                                <li class="nav-item "> <a class="nav-link" href="<?php echo e(url('rosters')); ?>"> <?php echo e(__('Rotas')); ?> </a> </li>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-arrow p-lg-0">
                                        <div class="dropdown-menu-links rounded-bottom delimiter-top p-lg-4">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <?php if(Auth::user()->acount_type == 1 || Auth::user()->getAddEmployeePermission() == 1): ?>
                                                        <a href="<?php echo e(url('doctors')); ?>" class="dropdown-item"><?php echo e(__('Doctors')); ?></a>
                                                    <?php endif; ?>
                                                    <?php if(Auth::user()->acount_type == 1): ?>
                                                        <a href="<?php echo e(url('teams')); ?>" class="dropdown-item"><?php echo e(__('Locations')); ?></a>
                                                    <?php endif; ?>
                                                    <?php if(Auth::user()->acount_type == 1 || Auth::user()->getAddRolePermission() == 1): ?>
                                                        <a href="<?php echo e(url('roles')); ?>" class="dropdown-item"><?php echo e(__('Roles')); ?></a>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <?php endif; ?>
                                <!-- Leave  -->
                                <li class="nav-item "> <a class="nav-link" href="<?php echo e(url('leave')); ?>"> <?php echo e(__('Leave')); ?> </a> </li>
                                <!-- Availability  -->
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><span class="model_form_title"><?php echo e(__('')); ?></span></h5>
...
<?php /**PATH /home/jovickxe/medtimes.co/resources/views/layouts/main.blade.php ENDPATH**/ ?>