<div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            <div class="custom-control custom-checkbox custom-control-inline">
                ...
                <label class="custom-control-label" for="customCheck2"><?php echo e(__('Set expiry date')); ?></label>
            </div>            
            <div class="custom-control custom-checkbox custom-control-inline">
                <input type="checkbox" class="custom-control-input set_password" id="customCheck1" value="yes" name="set_password">
                <label class="custom-control-label" for="customCheck1"><?php echo e(__('Only people with the password')); ?></label>
            </div>
        </div>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-12 expiry_date_box" style="display: none;">
        <label for="" class="form-control-label"><?php echo e(__('Expiry Date')); ?></label>
        <div class="form-group">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 password_box" style="display: none;">
        <label for="" class="form-control-label"><?php echo e(__('Set Password')); ?></label>
        <div class="form-group">
    ...
    <div class="col-12">
        <div class="form-group text-right">
            <input type="button" class="btn btn-sm btn-primary rounded-pill mr-auto create_link"
                value="<?php echo e(__('Create Link')); ?>" data-ajax-popup="true">
        </div>
    </div>
</div><?php /**PATH /home/jovickxe/medtimes.co/resources/views/rotas/shift_share.blade.php ENDPATH**/ ?>