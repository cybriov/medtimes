                    ...
                    <?php if($password_sts == 1): ?>
                        <div class="form_box_div">
                            <div class="form_box">
                                ...
                                <button class="btn login-pass"> <?php echo e(__('Submit')); ?> </button>
                            </div>
                        </div>
                            ...
                            <div>
                                <div class="clearfix mt-10">
                                    ...
                                    <div class="float-right">
                                        <button class="round_print_btn"> <?php echo e(__('Print')); ?> </button>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <?php if(!empty($users_name)): ?>
                                        <?php $__currentLoopData = $users_name; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><?php echo \App\Rotas::getdaterotas($week_date[0], $item->id, $location->id, 0); ?></td>
                                                <td><?php echo \App\Rotas::getdaterotas($week_date[1], $item->id, $location->id, 0); ?></td>
                                                <td><?php echo \App\Rotas::getdaterotas($week_date[2], $item->id, $location->id, 0); ?></td>
                                                <td><?php echo \App\Rotas::getdaterotas($week_date[3], $item->id, $location->id, 0); ?></td>
                                                <td><?php echo \App\Rotas::getdaterotas($week_date[4], $item->id, $location->id, 0); ?></td>
                                                <td><?php echo \App\Rotas::getdaterotas($week_date[5], $item->id, $location->id, 0); ?></td>
                                                <td><?php echo \App\Rotas::getdaterotas($week_date[6], $item->id, $location->id, 0); ?></td>
                                            </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php else: ?>
                                        <tr>
...
<?php /**PATH /home/jovickxe/medtimes.co/resources/views/rotas/share_shift_table.blade.php ENDPATH**/ ?>