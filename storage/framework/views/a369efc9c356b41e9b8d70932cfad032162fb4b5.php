<?php echo e(Form::open(['url' => 'employees', 'enctype' => 'multipart/form-data'])); ?>
    ...
    <div class="form-group">
        ...
        <?php echo e(Form::text('persal_no', null, ['class' => 'form-control', 'required' => false])); ?>
...
<?php /**PATH /home/jovickxe/medtimes.co/resources/views/employee/create.blade.php ENDPATH**/ ?>