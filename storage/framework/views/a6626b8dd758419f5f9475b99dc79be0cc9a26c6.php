                        ...
                        <div data-href="#tabs-1" class="list-group-item text-primary">
                            <div class="media">
                                ...
                                <div class="media-body ml-3">
                                    <a href="#" class="stretched-link h6 mb-1"><?php echo e(__('Hours & Costs')); ?></a>
                                </div>
                            </div>
                        </div>
                ...
                <div id="tabs-1" class="tabs-card ">
                    ...
                    <div class="tab-content pt-4">
                        <div class="tab-pane fade show active" id="daily_totals_tab" role="tabpanel">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="h6 mb-0"><?php echo e(__('Daily Totals')); ?></h5>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="tab-pane fade show " id="monthly_totals_tab" role="tabpanel">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="h6 mb-0"><?php echo e(__('Monthly Totals')); ?></h5>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="tab-pane fade show" id="employee_wise_totals_tab" role="tabpanel">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="h6 mb-0"><?php echo e(__('Employee Totals')); ?></h5>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="tab-pane fade show" id="location_totals_tab" role="tabpanel">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="h6 mb-0"><?php echo e(__('Location Totals')); ?></h5>
                                </div>
                        ...
                        <div class="tab-pane fade show" id="role_totals_tab" role="tabpanel">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="h6 mb-0"><?php echo e(__('Role Totals')); ?></h5>
                                </div>
                                <div class="card-body  align-self-center">
                ...
                <div id="tabs-2" class="tabs-card d-none">
                    <ul class="nav nav-dark nav-tabs nav-overflow" role="tablist">
                        <li class="nav-item">
                            <a href="#leave_totals_tab"  class="nav-link active" data-toggle="tab" role="tab" aria-controls="home" aria-selected="true">
                                <i class="fas fa-sign-out-alt mr-2"></i><?php echo e(__('Leave Totals')); ?>
                    ...
                    <div class="tab-content pt-4">
                        <div class="tab-pane fade show active" id="leave_totals_tab" role="tabpanel">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="h6 mb-0"><?php echo e(__('Leave Totals')); ?></h5>
                                </div>
                                <div class="card-body">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\medtimes\resources\views/report/index.blade.php ENDPATH**/ ?>