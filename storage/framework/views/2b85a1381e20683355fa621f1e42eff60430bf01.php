                ...
                <div class="col-md-6 d-flex align-items-center justify-content-between justify-content-md-end">                    
                    ...
                    <div class="dropdown btn btn-sm btn-white btn-icon-only rounded-circle ml-1" data-toggle="dropdown" title="<?php echo e(__('Menu')); ?>">
                        ...
                        <div class="dropdown-menu dropdown-menu-right employee_menu_listt">
                            <a href="<?php echo e(url('employees')); ?>" onclick="window.location.href=this;" class="dropdown-item"><?php echo e(__('View Employees')); ?></a>
                            <a href="<?php echo e(url('past-employees')); ?>" onclick="window.location.href=this;" class="dropdown-item"><?php echo e(__('Deleted Employees')); ?></a>                           
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4">
                <div class="card card-stats">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <h6 class="text-muted mb-1"><?php echo e(__('Current month new employee')); ?></h6>
            ...
            <div class="col-lg-4">
                <div class="card card-stats">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <h6 class="text-muted mb-1"><?php echo e(__('Current month rotas')); ?></h6>
        ...
        <div class="employee_menu view_employee">
                <div class="card">                    
                    <div class="card-header actions-toolbar border-0">
                        <div class="row justify-content-between align-items-center">
                            <div class="col">
                                <h6 class="d-inline-block mb-0 text-capitalize"><?php echo e(__('Employee')); ?></h6>
                            </div>
                    ...
                    <div class="table-responsive">
                        <table class="table align-items-center employee_tableese">
                            ...
                            <tr>
                                ...
                                <th scope="col"><?php echo e(__('Locations')); ?></th>
                                <th scope="col"><?php echo e(__('Role')); ?></th>
                                <th scope="col"><?php echo e(__('Wage / Salary')); ?></th>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\medtimes\resources\views/employee/index.blade.php ENDPATH**/ ?>