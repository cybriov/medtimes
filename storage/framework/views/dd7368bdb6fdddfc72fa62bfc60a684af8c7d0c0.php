            ...
            <div style="width:1000px;margin-left: auto;margin-right: auto; background-color: #dddddd26; height: 98vh;">
                <div style="background: #051C4B; padding: 20px 25px;">
                    <div style="background: #051C4B; padding: 20px 25px;display: inline-block;">
                        <img src="http://medtimes.co.za/storage/uploads/logo/logo.png" style="width: 100%; display: inline-block; float: left; max-width: 150px;">
                    </div>
...
<?php /**PATH /home/jovickxe/medtimes.co/resources/views/rotas/rotastable.blade.php ENDPATH**/ ?>