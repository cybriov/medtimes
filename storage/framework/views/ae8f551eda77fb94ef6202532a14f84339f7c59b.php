<?php echo e(Form::model($rotas, ['route' => ['rotas.update', $rotas->id], 'method' => 'PUT', 'class' => 'rotas_edit_frm'])); ?>
    ...
    <h5 class="modal-title"><span class="model_form_title"><?php echo e(__('Edit Shift')); ?></span></h5>
    <div class="row">
...
<?php /**PATH /home/jovickxe/medtimes.co/resources/views/rotas/edit.blade.php ENDPATH**/ ?>