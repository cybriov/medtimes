                    ...
                    <div class="rotas_filter_main_div">                        
                        ...
                        <div class="d-inline-block">
                            <a href="#" data-url2="<?php echo e(route('rotas.share_popup')); ?>"
                                class="btn btn-sm btn-md btn-white btn-icon-only rounded-circle ml-1 share_rotas_cls"  title="<?php echo e(__('Share roster')); ?>" data-size="lg" data-ajax-popup="false" data-title="<?php echo e(__('Share rotas')); ?>">
                                    ...
                                    <tr>
                                        <td colspan="8">
                                            <div class="text-center">
                                                ...
                                                <h6> <?php echo __('Please assign a doctor to this team.'); ?> </h6>
                                            </div>
                                        </td>
                                    </tr>
                                ...
                                <tr>
                                    <td colspan="8">
                                        <div class="text-center">
                                            <i class="fas fa-map-marker-alt text-primary fs-40"></i>
                                            <h2><?php echo e(__('Opps...')); ?></h2>
                                            <h6> <?php echo __('You must add a team to your account and assign doctors <br> before you can start building rosters.'); ?> </h6>
                                        </div>
                                    </td>
                                </tr>
                            <?php endif; ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/jovickxe/medtimes.co/resources/views/rotas/index.blade.php ENDPATH**/ ?>