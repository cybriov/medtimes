...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="form-group row mb-0">
                                                <button type="submit" class="btn btn-sm btn-primary btn-icon rounded-pill login-do-btn">
                                                    <a href="#"><span class="btn-inner--text text-white"><?php echo e(__('Sign in')); ?></span></a>
                                                </button>
                                            </div>
                                        </form>
                                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\medtimes\resources\views/auth/login.blade.php ENDPATH**/ ?>