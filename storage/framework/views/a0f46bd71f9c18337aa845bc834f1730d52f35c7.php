        ...
        <div class="row top-bar">
            <div class="col-lg-6 col-md-6 left-part">
                <ul>
                    <li>
                        <a href="#">
                            <img src="" alt="Medtimes" height="35px" width="auto" id="logo">
                        </a>
                    </li>
                    <ul id="menu">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 inner-text">
                ...
                <a href="/register/en" class="button" id="text-4"></a>
                <span id="text-5"></span>
            </div>
            <div class="col-lg-12 top-banner-img">
                <img src="" alt="Welcome to Medtimes" class="imagepreview" id="image">
            </div>
        </div>
    </div>
</div>
...
<?php /**PATH /home/jovickxe/medtimes.co/resources/views/custom_landing_page/custome-top-header-section.blade.php ENDPATH**/ ?>