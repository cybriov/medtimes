...
class LeaveRequestController extends Controller
{
    ...
    public function reply(Request $request,$id)
    {
        ...
        $name = $leaverequest->getCreatedByName->first_name.' '.$leaverequest->getCreatedByName->last_name;
        $first_name = $leaverequest->getCreatedByName->first_name;
        ...
        $requsst_string = '<span><b>'.$name.'</b> requests <b>'.$date_difference.' days </b> for <b> '.$dayyy.' </b>.</span><br>'.$first_name.' has '.$remaing_leave.' days holiday remaining in this year.';        
