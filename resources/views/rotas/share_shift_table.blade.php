                    ...
                    @if ($password_sts == 1)
                        <div class="form_box_div">
                            <div class="form_box">
                                ...
                                <button class="btn login-pass"> {{ __('Submit') }} </button>
                            </div>
                        </div>
                            ...
                            <div>
                                <div class="clearfix mt-10">
                                    ...
                                    <div class="float-right">
                                        <button class="round_print_btn"> {{ __('Print') }} </button>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    @if (!empty($users_name))
                                        @foreach ($users_name as $item)
                                            <tr>
                                                ...
                                                <td>{!! \App\Rotas::getdaterotas($week_date[0], $item->id, $location->id, 0) !!}</td>
                                                <td>{!! \App\Rotas::getdaterotas($week_date[1], $item->id, $location->id, 0) !!}</td>
                                                <td>{!! \App\Rotas::getdaterotas($week_date[2], $item->id, $location->id, 0) !!}</td>
                                                <td>{!! \App\Rotas::getdaterotas($week_date[3], $item->id, $location->id, 0) !!}</td>
                                                <td>{!! \App\Rotas::getdaterotas($week_date[4], $item->id, $location->id, 0) !!}</td>
                                                <td>{!! \App\Rotas::getdaterotas($week_date[5], $item->id, $location->id, 0) !!}</td>
                                                <td>{!! \App\Rotas::getdaterotas($week_date[6], $item->id, $location->id, 0) !!}</td>
                                            </tr>
                                        @endforeach
                                    @else
                                        <tr>
