...
<head>
    ...
    <title>{{ __('Medtimes') }} - A Rostering Tool For Medical Professionals</title>
                                    ...
                                    footer.forEach(function(element) {
                                        if (element == "logo") {
                                            ...
                                            content[val][element].forEach(function(
                                                ...
                                                data.forEach(function(data_val) {
                                                    menu_inner_html +=
                                                        `<li><a href="${data_val.image_href}"><img src="{{ $image_path . '/${data_val.image}' }}" id="section_footer_contact_${section_id}_${no}" alt="logo"></a></li>`;
                                                    menu_modal_html += `<div class="form-group">
