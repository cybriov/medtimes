            ...
            <div class="row top-bar">
                <div class="col-lg-6 col-md-6 left-part">
                    <ul>
                        <li>
                            <a href="#">
                                <img src="{{asset(Storage::url('uploads/logo/')).'/logo.png'}}" height="33px" width="130px" alt="Medtimes">
                            </a>
                        </li>
                        <li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 inner-text">
                    <h2>Medtimes</h2>
                    <span class="sub-heading">A Medical Rostering Tool</span>
                    <div class="body-text">
                ...
                <div class="col-lg-12 top-banner-img">
                    <img src="{{ asset('landing/images/top-banner.png') }}" alt="dashboard" class="image-shadow">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-12">
                ...
                <form action="#">
                    <div class="input-group mb-3">
                        ...
                        <button type="submit" class="btn btn-default rtl_btn_landing">Subscribe</button>
                    </div>
                </form>
            </div>
        </div>
