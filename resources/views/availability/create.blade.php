            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6 col-lg-{{ (Auth::user()->acount_type == 1) ? '2' : '3' }}">
                    <div class="form-group">
                        ...
                        {!! Form::select('repeat_week', ['1'=>__('Week'), '2'=> __('2 Week'), '3'=> __('3 Week'), '4'=> __('4 Week')], null, ['required' => false, 'data-placeholder'=> 'Yours Placeholder' ,'class'=> 'form-control js-single-select']) !!}
                    </div>
                </div>
